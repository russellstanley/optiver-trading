...
public:
    ...
    void bollingerBands(float ratio);
...
private:
    ...
    float MA = 0;                     // Moving average.
    float SD = 0;                     // Moving standard deviation.
    std::vector<float> ratios;        // Last 20 recorded ratios.

    float lowBollingerBand = 1;
    float highBollingerBand = 1;
